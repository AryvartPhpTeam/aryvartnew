    ...
    <div class="row mar-top1">
     ...
     <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="foot" style="border-right:none;">
          <h4>Contact</h4>
          <ul>
            <li><i class="fa fa-phone"></i> &nbsp; &nbsp;&nbsp;0413 224 5010</li>
            <li><i class="fa fa-envelope-o"></i> &nbsp; &nbsp;&nbsp;contact@aryvart.com</li>
            <li><i class="fa fa-map-marker"></i> &nbsp; &nbsp;&nbsp;Near,SBH, Puduchery Rd, Saram, Puducherry, 605013</li>
          </ul>
        </div>
      </div>   
    </div>
...
<footer>
  <div class="container">
    ...
    <div class="col-lg-6 col-md-6 col-sm-7 col-xs-8">
      <p>Copyright&copy; 2015 All Reserved by Aryvart 
    </div>
  </div>
</footer>
